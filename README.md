...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/autowrapt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12925&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/autowrapt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `autowrapt` can be installed with:

```
conda install autowrapt
```

It is possible to list all of the versions of `autowrapt` available on your platform with:
